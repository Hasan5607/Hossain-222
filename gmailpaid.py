...
ha = current.day
today = date.today()
#os.system('xdg-open https://www.youtube.com/@BDTermuxhacker.')
...
def snigdho_email():
    ...
    os.system('clear')
    snigdho_Hasan(logo)
    fastname = input(f'\033[0;97m[{xr}^{x}]\033[0;92m EXAMPLE : \033[0;93msnigdho, \x1b[38;5;208mhasan, \033[0;92mhossain ] \n\033[0;95m═════════════════════════════════════════ \n\033[0;97m[{xr}^{x}] \033[0;92mPUT CLONING FAST NAME:\033[0;93m ')
    os.system('clear')
    snigdho_Hasan(logo)
    lasttname = input(f'\033[0;97m[{xr}^{x}]\033[0;92m EXAMPLE : \033[0;93msnigdho, \x1b[38;5;208mhasan, \033[0;92mhossain ] \n\033[0;95m═════════════════════════════════════════ \n\033[0;97m[{xr}^{x}] \033[0;92mPUT CLONING LAST NAME:\033[0;93m ')
    snigdho_Hasan(logo)
...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com/hossain-BBHH/snigdho-mex/main/aproval.text').text
    if to in r:
        os.system('clear')
